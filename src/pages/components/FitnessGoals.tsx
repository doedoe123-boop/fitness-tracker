...
const FitnessGoals: React.FC = () => {
  ...
  return (
    <div className="mt-12">
      <h2 className="text-2xl font-bold mb-6 text-slate-900 dark:text-white">Fitness Goals</h2>
      
      {/* Add New Goal Form */}
      <motion.div 
        className="bg-white dark:bg-dark-secondary p-6 rounded-xl shadow-sm mb-8 border border-slate-100 dark:border-slate-700"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="flex items-end">
            <motion.button
              ...
              className="w-full bg-teal-600 text-white px-6 py-2 rounded-lg hover:bg-teal-700 dark:hover:bg-teal-500 transition-colors duration-300"
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div className="relative pt-1">
                <div className="overflow-hidden h-2 text-xs flex rounded bg-slate-100 dark:bg-dark-accent">
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: `${getProgressPercentage(goal)}%` }}
                    transition={{ duration: 0.5 }}
                    className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-teal-600 dark:bg-teal-500"
                  />
                </div>
              </div>
            </div>
